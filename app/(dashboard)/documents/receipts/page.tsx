...
export default async function ReceiptsPage({
  ...
  let query = supabase
    .from("documents")
    .select("*", { count: "exact" })
    .in("type", ["receipt", "sales_receipt", "cash_receipt"])
  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="flex items-center justify-between">
        ...
        <Button asChild>
          <Link href="/documents/create?type=receipt">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            View, filter, and manage all your receipts, sales receipts, and cash receipts
          </CardDescription>
        </CardHeader>
        <CardContent>
