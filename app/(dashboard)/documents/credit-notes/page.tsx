...
export default async function CreditNotesPage({
  ...
  let query = supabase
    .from("documents")
    .select("*", { count: "exact" })
    .in("type", ["credit_note", "credit_memo"])
  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="flex items-center justify-between">
        ...
        <Button asChild>
          <Link href="/documents/create?type=credit_note">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            View, filter, and manage all your credit notes and credit memos
          </CardDescription>
        </CardHeader>
        <CardContent>
