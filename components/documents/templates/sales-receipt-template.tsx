...
export function SalesReceiptTemplate({
  document,
  items,
  companyLogo,
    ...
    <div className="font-sans text-black p-10 leading-relaxed">
      ...
      <div className="flex justify-between items-start mb-12">
        <div className="space-y-3">
          <h1 className="text-4xl font-bold uppercase tracking-tight text-gray-800 mb-1">SALES RECEIPT</h1>
      ...
      <div className="grid grid-cols-2 gap-12 mb-12">
        <div className="space-y-2 bg-gray-50 p-6 rounded-lg shadow-sm">
          <h2 className="text-lg font-bold text-gray-700 mb-3 uppercase tracking-wide">Sold To:</h2>
        ...
        <div className="bg-gray-50 p-6 rounded-lg shadow-sm">
          ...
          <div className="grid grid-cols-2 gap-2">
            ...
            <p className="font-semibold text-gray-700 text-right">Sale Date:</p>
            <p className="text-right">{data.sale_date ? format(new Date(data.sale_date), "dd/MM/yyyy") : format(new Date(document.issue_date), "dd/MM/yyyy")}</p>
            ...
            {data.sale_location && (
              <>
                <p className="font-semibold text-gray-700 text-right">Sale Location:</p>
                <p className="text-right">{data.sale_location}</p>
              </>
            )}
