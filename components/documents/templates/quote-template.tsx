...
export function QuoteTemplate({
  ...
  const validUntil = data.valid_until ? format(new Date(data.valid_until), "dd/MM/yyyy") : 
                    document.due_date ? format(new Date(document.due_date), "dd/MM/yyyy") : 
    ...
    <div className="font-sans text-black p-10 leading-relaxed">
      ...
      <div className="flex justify-between items-start mb-12">
        <div className="space-y-3">
          <h1 className="text-4xl font-bold uppercase tracking-tight text-gray-800 mb-1">QUOTATION</h1>
      ...
      <div className="grid grid-cols-2 gap-12 mb-12">
        <div className="space-y-2 bg-gray-50 p-6 rounded-lg shadow-sm">
          <h2 className="text-lg font-bold text-gray-700 mb-3 uppercase tracking-wide">Quote For:</h2>
        ...
        <div className="bg-gray-50 p-6 rounded-lg shadow-sm">
          <h2 className="text-lg font-bold text-gray-700 mb-3 uppercase tracking-wide text-right">Quote Details:</h2>
          <div className="grid grid-cols-2 gap-2">
            <p className="font-semibold text-gray-700 text-right">Quote Date:</p>
            <p className="text-right">{format(new Date(document.issue_date), "dd/MM/yyyy")}</p>
            
            <p className="font-semibold text-gray-700 text-right">Valid Until:</p>
