...
export function EstimateTemplate({
  ...
  return (
    <div className="font-sans text-black p-10 leading-relaxed">
      {/* Header Section with Logo and Estimate Title */}
      <div className="flex justify-between items-start mb-8">
        <div className="space-y-2">
          <h1 className="text-3xl font-bold uppercase tracking-tight text-gray-800">ESTIMATE</h1>
      ...
      {/* Customer and Estimate Details Section */}
      <div className="grid grid-cols-2 gap-12 mb-10">
        <div className="space-y-2 bg-gray-50 p-6 rounded-lg shadow-sm">
          <h2 className="text-lg font-bold text-gray-700 mb-3 uppercase tracking-wide">Client Information</h2>
        ...
        <div className="bg-gray-50 p-6 rounded-lg shadow-sm">
          <h2 className="text-lg font-bold text-gray-700 mb-3 uppercase tracking-wide text-right">Estimate Details</h2>
          <div className="grid grid-cols-2 gap-2">
            <p className="font-semibold text-gray-700 text-right">Estimate Date:</p>
            <p className="text-right">{format(new Date(document.issue_date), "dd/MM/yyyy")}</p>
            
            <p className="font-semibold text-gray-700 text-right">Expiry Date:</p>
            <p className="text-right">{document.due_date ? format(new Date(document.due_date), "dd/MM/yyyy") : "N/A"}</p>
            
            {data.estimate_number && (
              <>
                <p className="font-semibold text-gray-700 text-right">Estimate #:</p>
                <p className="text-right">{data.estimate_number}</p>
              </>
            )}
